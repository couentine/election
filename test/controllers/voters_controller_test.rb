...
class VotersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post voters_url, params: { voter: { age: @voter.age, interests: @voter.interests, name: @voter.name } }
    end
  ...
  test "should update voter" do
    patch voter_url(@voter), params: { voter: { age: @voter.age, interests: @voter.interests, name: @voter.name } }
